...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.edaperfumes.com/blogs/art-of-wearing-seductive-fragrance-with-confidence' },
  ...
  openGraph: {
    ...
    description: 'Master the art of seduction with luxury fragrances. Oud and woody perfumes for men, elegantly presented in a luxury perfume box for style and confidence.',
    type: 'article',
    url: 'https://www.edaperfumes.com/blogs/art-of-wearing-seductive-fragrance-with-confidence',
